...
This project is indexed by GitNexus as **openclaw** (73611 symbols, 232263 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/openclaw/process/{processName}` — trace the full execution flow step by step
